  ...
  return (
    <>
      ...
      <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
        <div className="peer block flex h-8 w-full rounded-md bg-gray-50 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500"/>
        <div className="flex h-8 w-1/6 items-center rounded-lg bg-gray-500 px-4 text-sm font-medium text-white transition-colors hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"/>
      </div>           
      <div className="mt-6 flow-root">
        <div className="inline-block min-w-full align-middle">
          <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
...
export function SearchReservationsSkeleton() {
 ...
 export function CustomersSkeleton() {
  return (
    <div className="flex flex-row items-center justify-between border-b border-b border-gray-100 py-4">
    <div className="flex items-center">
    <div className="mr-2 h-8 w-8 rounded-full bg-gray-200"/>
    <div className="min-w-0">
    <div className="h-5 w-40 rounded-md-bg-gray-200"/>
